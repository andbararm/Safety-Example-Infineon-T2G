...
static const ARM_MPU_Region_t mpu_table[ZONES_NUM][MPU_REGIONS] = {
  ...
  /* Zone 'Zone_Com' */ 
  {
    ...
    { .RBAR = ARM_MPU_RBAR(3U, 0x40000000), .RASR = ARM_MPU_RASR_EX(1U, ARM_MPU_AP_FULL, ARM_MPU_ACCESS_DEVICE(1U),                                                 0x00U, ARM_MPU_REGION_SIZE_64MB) },
//  // ETH0 (0x40480000..0x4048FFFF)
//  { .RBAR = ARM_MPU_RBAR(3U, 0x40480000), .RASR = ARM_MPU_RASR_EX(1U, ARM_MPU_AP_FULL, ARM_MPU_ACCESS_DEVICE(1U),                                                 0x00U, ARM_MPU_REGION_SIZE_64KB) },
    { .RBAR = ARM_MPU_RBAR(4U, 0U), .RASR = 0U },
    { .RBAR = ARM_MPU_RBAR(5U, 0U), .RASR = 0U },
    { .RBAR = ARM_MPU_RBAR(6U, 0U), .RASR = 0U },
    { .RBAR = ARM_MPU_RBAR(7U, 0U), .RASR = 0U }
...
#warning Add peripherals required by Network once Ethernet driver is stable
