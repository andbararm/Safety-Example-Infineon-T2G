...
#if !defined(CYT4BF8CDS)
#error "Unexpected MPN; expected DEVICE:=CYT4BF8CDS. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif /* !defined(CYT4BF8CDS) */
