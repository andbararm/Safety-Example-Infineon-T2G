...
{
    .block = CYHAL_CLOCK_BLOCK_PERIPHERAL1_8BIT,
    .channel = 0,
...
{
    .clk_dst = (en_clk_dst_t)peri_0_group_1_div_8_0_GRP_NUM,
    .div_type = peri_0_group_1_div_8_0_HW,
    .div_num = peri_0_group_1_div_8_0_NUM,
};
...
{
    /* MTB placeholder. */
    Cy_SysClk_PeriPclkAssignDivider(PCLK_SCB0_CLOCK, CY_SYSCLK_DIV_8_BIT, 0U);
    /* MTB placeholder. */
    /* MTB placeholder. */
    /* MTB placeholder. */
    /* MTB placeholder. */
